    ...
    <div>
      ...
      >
        ...
        {fitnessGoalFilter && (
          ...
          >
            <Badge
              className="flex items-center gap-1.5 px-3 py-1.5 bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors cursor-pointer"
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          >
            <span className="font-semibold">
              Training {filteredClients.length} Client{filteredClients.length !== 1 ? "s" : ""}!
            </span>{" "}
